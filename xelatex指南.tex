...
\newcommand*\circled[1]{%
  \tikz[baseline=(char.base)]\node[shape=circle,draw,inner sep=1pt,minimum size=8pt] (char) {#1};}
...
TeX中读入文件一般用input命令即可，此外verbatim宏包还提供了原文照列的verbatiminput命令，还有fancyvrb宏包有Verbatiminput命令。或者类似上面的有：\textbackslash newread，\textbackslash openin，\textbackslash read 和 \textbackslash closein命令。
