...
\verb+\renewcommand{\thefigure}{\arabic{chapter}-\arabic{figure}}+
...
它的实现机制应该是使用了这个\verb+\@addtoreset{counter}{chapter}+命令。
